...
public class ScoreCheckForm {
	 ...
	 */
	public ScoreCheckForm(int planId) {
		initialize(planId);
	}
	 ...
	 */
	private void initialize(int planId) {
		frame = new JFrame();
		...
		scrollPane.setBounds(0, 0, 544, 226);
		...
		for (int i = 0; i < trainPlanManagerDTO.size(); i++) {
			...
			vector.addElement(trainPlanManagerDTO.get(i).getTrainTurnOut());
			vector.addElement(trainPlanManagerDTO.get(i).getTurnOutScore());
			vector.addElement(trainPlanManagerDTO.get(i).getExamScore());
			vector.addElement(trainPlanManagerDTO.get(i).getTotalScore());
		...
		JLabel label_6 = new JLabel("\u5206\u6570\u67E5\u770B");
		label_6.setFont(new Font("宋体", Font.PLAIN, 20));
		label_6.setHorizontalAlignment(SwingConstants.CENTER);
		label_6.setBounds(132, 0, 253, 40);
